...
function CssQuiz() {
  ...
  function changeQue() {
    if (queIndex < CssQuestion.length - 1) {
  ...
  function updateScore() {
    if (trackClick === CssQuestion[queIndex].ans) {
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="score-section d-flex">
            <Scoreboard allQuestion={CssQuestion.length} nowScore={changeScore} />
            <>
              <div className="d-flex m-2 w-100 rounded border justify-content-center align-items-center">
                ...
                <span className="name d-block mx-2 fs-2 ">CSS</span>
              </div>
            </>
          </div>
        </div>
            ...
            <div className="col-12">
              <div className="mb-5">
                <span className="d-block fs-2  w-100 text-center">
                  {queIndex + 1}.{CssQuestion[queIndex].question}
                </span>
              </div>
            </div>
            <div className="col-12">
