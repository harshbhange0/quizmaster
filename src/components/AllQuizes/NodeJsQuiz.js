...
import { NodeQuestion } from"../question/NodeQuestion";
...
function NodeJsQuiz() {
  ...
  function changeQue() {
    if (queIndex < NodeQuestion.length - 1) {
  ...
  function updateScore() {
    if (trackClick === NodeQuestion[queIndex].ans) {
                    ...
                    <div className="col-12 ">
                      ...
                      <div className="container">
                        <div className="score-section d-flex">
                          <Scoreboard
                            allQuestion={NodeQuestion.length+1}
                          ...
                          <div className="col-12">
                            <div className="mb-5">
                              <span className="d-block fs-2  w-100 text-center">
                                {queIndex + 1}.
                                {NodeQuestion[queIndex].question}
                              </span>
                            </div>
                          </div>
                          <div className="col-12">
                            <div className="w-100 d-flex flex-column justify-content-center align-items-center">
                              {NodeQuestion[queIndex].option.map(
                                (option, i) => {
                                  return (
                                    <button
                                    key={i} 
